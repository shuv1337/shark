...
Complete Phase 5: provision `shark-prod`, configure exe.dev and Cloudflare DNS, implement the safe health/readiness boundary, create Bitwarden-backed secret delivery, implement WAL-safe Restic backups, and deploy immutable source-linked images with a restricted manual workflow.
